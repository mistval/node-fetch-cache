...
function getHeadersCacheKeyJson(headersObj) {
    return Object.fromEntries(Object.entries(headersObj)
...
async function getResponse(cache, requestArguments) {
    ...
    try {
        ...
        return new NFCResponse(newlyCachedData.bodyStream, newlyCachedData.metaData, ejectSelfFromCache, false);
    }
    finally {
